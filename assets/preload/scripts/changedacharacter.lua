...
local ofsy = 0
local mult = 1.25
characterNames = {'bf', 'bambi', 'dave', 'tristan'} --character json name
characterDisplays = {'Boyfriend', 'Bambi', 'Dave', 'Tristan'} --display name for text
characterLimit = {3, 1, 3, 1} --how many variations does the character have
...
function setVariation()
  ...
  elseif variation == 2 then
    characterNames = {'bf-christmas', 'bambi-3d', 'dave-insanity', 'tristan'} --character json name
    characterDisplays = {'Boyfriend (Christmas)', 'Bambi (Cheating)', 'Dave (Insanity)', 'Tristan'} --display name for text
  elseif variation == 3 then
    characterNames = {'3d-bf', 'bambi', 'dave-3d', 'tristan'} --character json name
    characterDisplays = {'Boyfriend (3D)', 'Bambi', '3D Dave', 'Tristan'} --display name for text
  end
end
